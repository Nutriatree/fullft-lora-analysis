"""PEFT LoRA strategy for the shared PubMedQA training engine."""
...
from pubmedqa.training.engine import FullFineTuneConfig, PubMedQATrainingEngine
from pubmedqa.training.schedules import normalize_checkpoint_percents
...
ENV_LEARNING_RATE = TRAIN_LORA_CONFIG.env_learning_rate
...
ENV_GRADIENT_CHECKPOINTING = TRAIN_LORA_CONFIG.env_gradient_checkpointing
...
DEFAULT_DISTRIBUTED_MODE = TRAIN_FULL_FINE_TUNE_CONFIG.default_distributed_mode
...
DEFAULT_LEARNING_RATE = TRAIN_LORA_CONFIG.default_learning_rate
DEFAULT_LAYER_SCOPE = TRAIN_LORA_CONFIG.default_layer_scope
...
class LoRAFineTuneCliConfig:
    ...
    def from_env(cls) -> "LoRAFineTuneCliConfig":
        ...
        config = LoRAFineTuneConfig(
            ...
            fsdp_cpu_offload=_env_bool(ENV_FSDP_CPU_OFFLOAD, False),
        )
