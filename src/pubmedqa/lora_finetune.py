...
ENV_LORA_TARGET_MODULES = "PUBMEDQA_LORA_TARGET_MODULES"
ENV_LORA_TARGET_LAYERS = "PUBMEDQA_LORA_TARGET_LAYERS"
ENV_LORA_TARGET_LAYERS_FILE = "PUBMEDQA_LORA_TARGET_LAYERS_FILE"
ENV_LORA_LAYER_SCOPE = "PUBMEDQA_LORA_LAYER_SCOPE"
ENV_LORA_RANK = "PUBMEDQA_LORA_RANK"
ENV_LORA_ALPHA = "PUBMEDQA_LORA_ALPHA"
ENV_LORA_DROPOUT = "PUBMEDQA_LORA_DROPOUT"
ENV_LORA_BIAS = "PUBMEDQA_LORA_BIAS"
ENV_LORA_TASK_TYPE = "PUBMEDQA_LORA_TASK_TYPE"
ENV_LORA_MODULES_TO_SAVE = "PUBMEDQA_LORA_MODULES_TO_SAVE"
ENV_LORA_MERGE_FOR_EVAL = "PUBMEDQA_LORA_MERGE_FOR_EVAL"

DEFAULT_METHOD_NAME = "lora"
DEFAULT_CONDITION = "lora"
DEFAULT_RUN_TAG = "L1"
DEFAULT_LORA_TARGET_MODULES = ("q_proj", "v_proj")
DEFAULT_LORA_TARGET_LAYERS: tuple[int, ...] = ()
DEFAULT_LORA_RANK = 8
DEFAULT_LORA_ALPHA = 16.0
DEFAULT_LORA_DROPOUT = 0.0
DEFAULT_LORA_BIAS = "none"
DEFAULT_LORA_TASK_TYPE = "CAUSAL_LM"
DEFAULT_LORA_MODULES_TO_SAVE: tuple[str, ...] = ()
DEFAULT_LORA_MERGE_FOR_EVAL = False
