...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-tag", default=TRAIN_CONFIG.default_run_tag)
    parser.add_argument("--method-name", default=TRAIN_CONFIG.default_method_name)
    parser.add_argument("--condition", default=TRAIN_CONFIG.default_condition)
    ...
    parser.add_argument(
        "--learning-rate", type=float, default=TRAIN_CONFIG.default_learning_rate
    )
    parser.add_argument(
