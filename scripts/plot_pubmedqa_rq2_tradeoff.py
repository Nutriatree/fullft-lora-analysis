#!/usr/bin/env python3
"""Create the RQ2 LoRA performance–parameter trade-off figure."""
...
from pubmedqa.reporting.figures.rq2_tradeoff import generate_rq2_tradeoff_figure
